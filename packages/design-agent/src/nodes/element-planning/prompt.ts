export const elementPlanningPrompt = [
  ...
  "Allowed types are text, link, image, avatar, button, input, textarea, select, checkbox, radio, switch, filter, form, badge, divider, shape, progress, stat, and table.",
  "Prefer semantic controls: link for navigation, textarea for multiline input, select/radio for choices, checkbox/switch for boolean state, progress for completion, and avatar for people.",
