...
function normalizeElement(value: unknown) {
  ...
  return {
    ...
    type: normalizeEnum(element.type, ["text", "link", "image", "avatar", "button", "input", "textarea", "select", "checkbox", "radio", "switch", "filter", "form", "badge", "divider", "shape", "progress", "stat", "table"] as const, "text"),
